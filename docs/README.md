...
| [plugin-architecture.md](plugin-architecture.md) | 想扩展功能 / 写插件 | 插件接口与发现机制、内置 sandbox / rag / **evolve（自进化）**、与核心的集成点、信任边界（P8 / P9） |
...
**加一个能力又不想动核心** → plugin-architecture（插件能贡献什么 → 最小可用插件 → 照着内置的 sandbox / rag 抄）
